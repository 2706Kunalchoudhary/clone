...
export default function PBT(){
    ...
    return(
        <View style={styles.main}>
            ...
            <Image style={styles.icon} source={require('../../image/icons8-instagram-reels-50.png')}/>
            </TouchableOpacity>
            <TouchableOpacity onPress={()=> navigation.navigate(Activity)}>
            <Image style={styles.icon} source={require('../../image/heart.png')}/>
            </TouchableOpacity>
            <TouchableOpacity>
            <Image style={[styles.icon,{borderRadius:50,borderWidth:2,borderColor:"black"}]} source={{uri:'https://i.pinimg.com/originals/17/b6/ce/17b6cec812cd4e0e4bb2e2a2e949e68b.jpg'}}/>
            </TouchableOpacity>
        </View>
    )
}
